...
execute positioned 0.0 0 0.0 run summon marker ^ ^0.35 ^1 {Tags:["direction"]}
...
data modify entity @e[type=snowball,tag=projectile,limit=1] Motion set from entity @e[type=marker,tag=direction,limit=1] Pos
